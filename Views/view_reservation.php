...
' <?php if(isset($nv3)){ echo $nv3; } ?>>
    ...
    <!-- !PAGE CONTENT! -->
<div class="w3-main w3-content w3-padding" style="max-width:3000px;margin-top:-10px; ">
...
<?php
 ...
 $i = 0;
  foreach ($data as $key => $value) {
    if ($i != 4  ) {
      echo "<a href='?controller=reservation&action=show_reservation&name=". urlencode($value['name']) . "' class='a'>
      <div class='w3-quarter' id='change' onmouseenter='select()' onmouseleave='unselect()' style='padding-top:50px; width:400px; padding-bottom:50px; padding-left:80px; padding-right:80px; border-radius: 20px; margin-left: 10px; margin-top:10px; margin-bottom:40px;' >
          ...
          max-width: 45ch;'>" . $value['summary'] ."</span>
